...
<head>
    ...
    <link href='{{ asset('assets/auth/plugins/toastr/toastr.min.css') }}' rel='stylesheet'>
    ...
    <!-- SLEEK CSS -->
    <link id="sleek-css" rel="stylesheet" href="{{ asset('assets/auth/css/sleek.css') }}" />
...
<body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
                        ...
                        <ul class="nav navbar-nav">
                                                ...
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                        ...
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/auth/img/user/u2.jpg') }}"
                                                                    alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/auth/img/user/u1.jpg') }}"
                                                                    alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/auth/img/user/u5.jpg') }}"
                                                                    alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                ...
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/auth/img/user/u6.jpg') }}"
                                                                    alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)"
                                                            ...
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle"
                                                                    src="{{ asset('assets/auth/img/user/u7.jpg') }}"
                                                                    alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                            ...
                            <li class="dropdown user-menu">
                                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <img src="{{ asset('assets/auth/img/user/user.png') }}" class="user-image"
                                        alt="User Image" />
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-header">
                                        <img src="{{ asset('assets/auth/img/user/user.png') }}" class="img-circle"
                                            alt="User Image" />
                                    ...
                                    <li class="dropdown-footer">
                                        ...
                                        <a id="logout-button"> <i class="mdi mdi-logout"></i> Log
                                            Out </a>
                                    </li>
                                </ul>
                            </li>
    ...
    <script src='{{ asset('assets/auth/js/vector-map.js') }}'></script>
    ...
    <script src='{{ asset('assets/auth/js/date-range.js') }}'></script>
    ...
    <script src='{{ asset('assets/auth/plugins/toastr/toastr.min.js') }}'></script>
    ...
    <script src="{{ asset('assets/auth/js/sleek.js') }}"></script>
    <link href="{{ asset('assets/auth/options/optionswitch.css') }}" rel="stylesheet">
    <script src="{{ asset('assets/auth/options/optionswitcher.js') }}"></script>
</body>
